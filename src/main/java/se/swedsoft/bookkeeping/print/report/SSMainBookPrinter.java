...
public class SSMainBookPrinter extends SSPrinter {
    ...
    protected SSDefaultTableModel getModel() {
        ...
        String iPeriodText = String.format(
                ...
                iAccountFrom.getNumber(), iAccountTo.getNumber());

        if (iProject != null) {
            iPeriodText = iPeriodText
                    + String.format(
                            SSBundle.getBundle().getString("mainbookreport.period.project"),
                            iProject.getNumber());
        }
        if (iResultUnit != null) {
            iPeriodText = iPeriodText
                    + String.format(
                            SSBundle.getBundle().getString(
                                    "mainbookreport.period.resultunit"),
