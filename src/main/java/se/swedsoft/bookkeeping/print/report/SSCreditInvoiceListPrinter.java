...
public class SSCreditInvoiceListPrinter extends SSPrinter {
    ...
    protected SSDefaultTableModel getModel() {
        ...
        SSDefaultTableModel<SSCreditInvoice> iModel = new SSDefaultTableModel<>() {
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                ...
                case 8:
                    ...
                    iSum = iSum.add(
                            SSCreditInvoiceMath.getTotalSum(iInvoice).multiply(
                ...
                case 9:
                    ...
                    iTaxSum = iTaxSum.add(
                            SSCreditInvoiceMath.getTotalTaxSum(iInvoice).multiply(
                                    iInvoice.getCurrencyRate()));
                    value = iTaxSum;
                    break;
                }
    ...
    private class SSInvoiceRowPrinter extends SSPrinter {
        ...
        public String toString() {
            ...
            sb.append(
                    "se.swedsoft.bookkeeping.print.report.SSCreditInvoiceListPrinter.SSInvoiceRowPrinter");
