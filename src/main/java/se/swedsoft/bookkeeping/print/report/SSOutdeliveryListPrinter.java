...
public class SSOutdeliveryListPrinter extends SSPrinter {
    ...
    protected SSDefaultTableModel getModel() {
        ...
        SSDefaultTableModel<SSOutdelivery> iModel = new SSDefaultTableModel<>() {
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                ...
                case 1:
                    value = iOutdelivery.getLocalDate() == null
                            ? null
                            : iFormat.format(se.swedsoft.bookkeeping.util.SSDateUtil.toDate(iOutdelivery.getLocalDate()));
                    break;
        ...
        Collections.sort(iOutdeliveries, (o1, o2) -> o1.getNumber() - o2.getNumber());
    ...
    private class SSInventoryRowPrinter extends SSPrinter {
        ...
        public String toString() {
            ...
            sb.append(
                    "se.swedsoft.bookkeeping.print.report.SSOutdeliveryListPrinter.SSInventoryRowPrinter");
