...
public class SSTenderPrinter extends SSPrinter {
    ...
    private void addParameters() {
        ...
        addParameter("date", iTender.getLocalDate());
        ...
        addParameter("tender.deliveryadress.address1",
                iTender.getDeliveryAddress().getAddress1());
        addParameter("tender.deliveryadress.address2",
                iTender.getDeliveryAddress().getAddress2());
        addParameter("tender.deliveryadress.zipcode",
                iTender.getDeliveryAddress().getZipCode());
        addParameter("tender.deliveryadress.city", iTender.getDeliveryAddress().getCity());
        addParameter("tender.deliveryadress.country",
                iTender.getDeliveryAddress().getCountry());

        addParameter("tender.invoiceadress.name", iTender.getInvoiceAddress().getName());
        addParameter("tender.invoiceadress.address1",
                iTender.getInvoiceAddress().getAddress1());
        addParameter("tender.invoiceadress.address2",
                iTender.getInvoiceAddress().getAddress2());
        addParameter("tender.invoiceadress.zipcode",
                iTender.getInvoiceAddress().getZipCode());
        addParameter("tender.invoiceadress.city", iTender.getInvoiceAddress().getCity());
        addParameter("tender.invoiceadress.country",
                iTender.getInvoiceAddress().getCountry());
