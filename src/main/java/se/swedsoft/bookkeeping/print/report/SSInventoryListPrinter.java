...
public class SSInventoryListPrinter extends SSPrinter {
    ...
    protected SSDefaultTableModel getModel() {
        ...
        SSDefaultTableModel<SSInventory> iModel = new SSDefaultTableModel<>() {
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                ...
                case 1:
                    value = iInventory.getLocalDate() == null
                            ? null
                            : iInventory.getLocalDate().format(iLocalDateFormat);
                    break;
        ...
        Collections.sort(iInventories, (o1, o2) -> o1.getNumber() - o2.getNumber());
