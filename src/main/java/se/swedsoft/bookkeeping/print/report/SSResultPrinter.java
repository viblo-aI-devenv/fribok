...
public class SSResultPrinter extends SSPrinter {
    ...
    protected SSResultCalculator getCalculator() {
        return new SSResultCalculator(iYearData, getLocalDateFrom(), getLocalDateTo(), null, null);
    }
    ...
    public String toString() {
        ...
        sb.append(", iLastVisibleSummaryGroup=").append(iLastVisibleSummaryGroup);
        sb.append(", iShowBudget=").append(iShowBudget);
        sb.append(", iShowPrevYear=").append(iShowPrevYear);
